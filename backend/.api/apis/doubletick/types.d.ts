...
export type GetChatWindowStatusMetadataParam = FromSchema<typeof schemas.GetChatWindowStatus.metadata>;
export type GetChatWindowStatusResponse200 = FromSchema<typeof schemas.GetChatWindowStatus.response['200']>;
export type GetChatWindowStatusResponse400 = FromSchema<typeof schemas.GetChatWindowStatus.response['400']>;
export type GetChatWindowStatusResponse401 = FromSchema<typeof schemas.GetChatWindowStatus.response['401']>;
export type GetChatWindowStatusResponse404 = FromSchema<typeof schemas.GetChatWindowStatus.response['404']>;
...
export type GetTeamMemberDetailsMetadataParam = FromSchema<typeof schemas.GetTeamMemberDetails.metadata>;
export type GetTeamMemberDetailsResponse200 = FromSchema<typeof schemas.GetTeamMemberDetails.response['200']>;
export type GetTeamMemberDetailsResponse400 = FromSchema<typeof schemas.GetTeamMemberDetails.response['400']>;
export type GetTeamMemberDetailsResponse401 = FromSchema<typeof schemas.GetTeamMemberDetails.response['401']>;
export type GetTeamMemberDetailsResponse404 = FromSchema<typeof schemas.GetTeamMemberDetails.response['404']>;
export type GetTeamMemberDetailsResponse422 = FromSchema<typeof schemas.GetTeamMemberDetails.response['422']>;
